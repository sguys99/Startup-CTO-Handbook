...
> `humanized` 상태: Phase 1~5의 모든 절(25개), Phase 6(맺음말), Phase 7(참고문헌), Phase 8(용어집), Phase 9(저자·출판사 소개)가 윤문 완료(29개).
> 모든 절의 본문 번역·윤문이 완료됐다. 남은 단계는 사용자 리뷰(reviewed)다.
...
## Phase 8 — Glossary (1/1 절 humanized)

- [x] `08-glossary.md` — Glossary (원문 3507–3561)
  - [x] draft  · [x] humanized  · [ ] reviewed
