...
> 현재 `04-technical-team-management/02-tech-debt.md`(파일럿)만 `humanized` 상태.
...
## Phase 1 — Introduction (0/3 절)

- [ ] `01-introduction/index.md` — Introduction (인트로) (원문 122–)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `01-introduction/the-author.md` — The Author (원문 미확정)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `01-introduction/using-this-book.md` — Using this Book (원문 ~208)
  - [ ] draft  · [ ] humanized  · [ ] reviewed

## Phase 2 — Business Processes (0/1 절)

- [ ] `02-business-processes.md` — Business Processes (원문 208–214)
  - [ ] draft  · [ ] humanized  · [ ] reviewed

## Phase 3 — People & Culture (0/7 절)

- [ ] `03-people-and-culture/01-management-fundamentals.md` — Management Fundamentals (원문 217–743)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `03-people-and-culture/02-hiring-and-interviewing.md` — Hiring and Interviewing (원문 744–1237)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `03-people-and-culture/03-onboarding.md` — Onboarding (원문 1238–1369)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `03-people-and-culture/04-performance-management.md` — Performance Management (원문 1370–1571)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `03-people-and-culture/05-team-makeup.md` — Team Makeup (원문 1572–1695)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `03-people-and-culture/06-leadership-responsibilities.md` — Leadership Responsibilities (원문 1696–1855)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `03-people-and-culture/07-cto-types.md` — Which Type of Startup CTO Are You? (원문 1856–1917)
  - [ ] draft  · [ ] humanized  · [ ] reviewed

## Phase 4 — Technical Team Management (1/5 절)

- [ ] `04-technical-team-management/01-tech-culture.md` — Tech Culture and General Philosophy (원문 1924–2017)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [x] `04-technical-team-management/02-tech-debt.md` — Tech Debt (원문 2018–2110) ✅ 파일럿 완료
  - [x] draft  · [x] humanized  · [ ] reviewed
- [ ] `04-technical-team-management/03-technology-roadmap.md` — Technology Roadmap (원문 2111–2161)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `04-technical-team-management/04-tech-process.md` — Tech Process (원문 2162–2347)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `04-technical-team-management/05-developer-experience.md` — Developer Experience (DX) (원문 2348–2414)
  - [ ] draft  · [ ] humanized  · [ ] reviewed

## Phase 5 — Tech Architecture (0/9 절)

- [ ] `05-tech-architecture/01-architecture.md` — Architecture (원문 2415–2691)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
- [ ] `05-tech-architecture/02-data-and-analytics.md` — Data and Analytics (원문 2692–2766)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
...
- [ ] `06-conclusion.md` — Conclusion: Measuring Success (원문 3427–3451)
  - [ ] draft  · [ ] humanized  · [ ] reviewed

## Phase 7 — Book References (0/1 절)

- [ ] `07-references.md` — Book References (원문 3379–3506)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
...
- [ ] `09-about.md` — About the author / About the publisher (원문 3562–)
  - [ ] draft  · [ ] humanized  · [ ] reviewed
